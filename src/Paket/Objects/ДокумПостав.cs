...
namespace IIS.Paket
{
    ...
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Paket.Организация fОрганизация;
        
        private IIS.Paket.Клиенты fКлиенты;
        
        private IIS.Paket.DetailArrayOfТЧИнфОЗак fТЧИнфОЗак;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Paket.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Paket.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Paket.Организация Организация
        {
            get
            {
                ...
                IIS.Paket.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Paket.DetailArrayOfТЧИнфОЗак ТЧИнфОЗак
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗак = new IIS.Paket.DetailArrayOfТЧИнфОЗак(this);
                }
                IIS.Paket.DetailArrayOfТЧИнфОЗак result = this.fТЧИнфОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставE", typeof(IIS.Paket.ДокумПостав));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставL", typeof(IIS.Paket.ДокумПостав));
                }
            }
        }
    }
