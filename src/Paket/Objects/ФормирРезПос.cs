...
namespace IIS.Paket
{
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Paket.СтатусЗаказа fСтатусЗаказа;
        
        private bool fНаличиеДеф;
        
        private IIS.Paket.УдовлКл fУдовлКл;
        
        private IIS.Paket.ФормирРаспред fФормирРаспред;
        ...
        public virtual IIS.Paket.СтатусЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.Paket.СтатусЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.Paket.УдовлКл УдовлКл
        {
            get
            {
                ...
                IIS.Paket.УдовлКл result = this.fУдовлКл;
        ...
        [PropertyStorage(new string[] {
                "ФормирРаспред"})]
        [NotNull()]
        public virtual IIS.Paket.ФормирРаспред ФормирРаспред
        {
            get
            {
                ...
                IIS.Paket.ФормирРаспред result = this.fФормирРаспред;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосE", typeof(IIS.Paket.ФормирРезПос));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосL", typeof(IIS.Paket.ФормирРезПос));
                }
            }
        }
    }
