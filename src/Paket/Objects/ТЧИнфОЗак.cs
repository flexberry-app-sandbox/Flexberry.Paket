...
namespace IIS.Paket
{
    ...
    public class ТЧИнфОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Paket.Товары fТовары;
        ...
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.Paket.Товары Товары
        {
            get
            {
                ...
                IIS.Paket.Товары result = this.fТовары;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Paket.ДокумПостав.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОЗакE", typeof(IIS.Paket.ТЧИнфОЗак));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОЗак : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Paket.DetailArrayOfТЧИнфОЗак members)

        // *** End programmer edit section *** (IIS.Paket.DetailArrayOfТЧИнфОЗак members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОЗак(IIS.Paket.ДокумПостав fДокумПостав) : 
                base(typeof(ТЧИнфОЗак), ((ICSSoft.STORMNET.DataObject)(fДокумПостав)))
        {
        }
        
        public IIS.Paket.ТЧИнфОЗак this[int index]
        {
            get
            {
                return ((IIS.Paket.ТЧИнфОЗак)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Paket.ТЧИнфОЗак dataobject)
        {
