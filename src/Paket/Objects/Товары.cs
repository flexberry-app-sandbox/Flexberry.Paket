...
namespace IIS.Paket
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Paket.ЕдИзм fЕдИзм;
        ...
        public virtual IIS.Paket.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Paket.ЕдИзм result = this.fЕдИзм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Paket.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Paket.Товары));
                }
            }
        }
    }
